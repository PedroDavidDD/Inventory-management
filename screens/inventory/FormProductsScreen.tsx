...
const FormProducts = () => {
  ...
  const { addProduct, updateProduct, getProductById, tags } = useProductStore();

  // Estado inicial del formulario
  const [formData, setFormData] = useState<
    Omit<Product, "id" | "createdAt" | "status">
  >({
    userId: user?.id || "",
    name: "",
  ...
  >(null);
  // Etiquetas disponibles desde el store
  ...
  }, [isEditing, editId, user, loadProductForEdit, resetForm]);
  ...
  const calculateProductStatus = (
    ...
    notifyDaysBefore: number | undefined
  ): ProductStatus => {
    ...
    >
      ...
      <View style={styles.dateRow}>
        ...
        >
          ...
          <Text>
            Ingreso: {new Date(formData.entryDate).toLocaleDateString("es-ES")}
          </Text>
        </TouchableOpacity>
      ...
      <View style={styles.toggleContainer}>
        ...
        <View style={styles.toggleRow}>
          {formData.isEnabled ? (
            <Text style={[formData.isEnabled && styles.activeSwitch]}>
              Habilitado
            </Text>
          ) : (
            <Text style={[!formData.isEnabled && styles.desabledSwitch]}>
              Deshabilitado
            </Text>
          )}
          <Switch
      ...
      <View style={styles.alertsContainer}>
        ...
        <View style={styles.alertRow}>
          ...
          <Switch
            ...
            onValueChange={(newValue) =>
              setFormData({ ...formData, useExpirationAlert: newValue })
            }
          />
        </View>
        <View style={styles.alertRow}>
          ...
          <Switch
            ...
            onValueChange={(newValue) =>
              setFormData({ ...formData, useLowStockAlert: newValue })
            }
          />
        </View>
        <View style={styles.alertRow}>
          ...
          <Switch
            ...
            onValueChange={(newValue) =>
              setFormData({ ...formData, useRecurrentAlert: newValue })
            }
          />
        </View>
      </View>
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      (formData.alertDays || []).includes(dayIndex) &&
                        styles.selectedDayOfWeekButton,
                    ]}
                    onPress={() => {
      ...
      {showDatePicker && (
        <DateTimePicker
          ...
          onChange={(event, date) => {
            ...
            if (date) {
              const field =
                showDatePicker === "entry" ? "entryDate" : "expirationDate";
